    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-success text-white">
            <div class="card-body text-center">
                ...
                <h4><?php
                    $totalPresent = array_sum(array_column($attendance, 'status') === 'present' ? 1 : 0);
                    echo $totalPresent;
                ?></h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-danger text-white">
            <div class="card-body text-center">
                ...
                <h4><?php
                    $totalAbsent = array_sum(array_column($attendance, 'status') === 'absent' ? 1 : 0);
                    echo $totalAbsent;
                ?></h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-warning text-white">
            <div class="card-body text-center">
                ...
                <h4><?php
                    $totalLate = array_sum(array_column($attendance, 'status') === 'late' ? 1 : 0);
                    echo $totalLate;
                ?></h4>
